...
import com.yuning.gao.dao.manager.UserManager;
import com.yuning.gao.dao.mapper.admin.SysUserMapper;
...
import com.yuning.gao.util.WXDecrypt;
...
public class UserServiceImpl implements UserService {
    ...
    public ResDTO updateUser(User user) {
        ...
        return RsJsonManager.successDate(map);
    }
    ...
    public ResDTO decrypt(User user) {
        ...
        return RsJsonManager.successDate(JsonUtils.toBean(result, Map.class));
    }
